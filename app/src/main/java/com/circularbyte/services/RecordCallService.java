package com.circularbyte.services;
...
import com.circularbyte.callrecorder.AppPreferences;
import com.circularbyte.callrecorder.LocalBroadcastActions;
import com.circularbyte.callrecorder.MainActivity;
    ...
    private void startRecording(CallLog phoneCall) {
        if (!isRecording) {
            ...
            try {
                ...
                file = File.createTempFile("recordcall", ".mp3", dir);
