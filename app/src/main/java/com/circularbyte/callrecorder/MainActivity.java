...
import com.circularbyte.AudioListActivity;
import com.circularbyte.AudioTrimmerActivity;
import com.circularbyte.PendingJobService;
import com.circularbyte.customAudioViews.SoundFile;
import com.circularbyte.database.CallLog;
...
public class MainActivity extends AppCompatActivity implements RecordingFragment.OnListFragmentInteractionListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaController.MediaPlayerControl {
    ...
    FloatingActionButton fab,fabtwo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this,AudioTrimmerActivity.class));
            }
        });
        ...
        Intent pendingJobService = new Intent(this, PendingJobService.class);
        startService(pendingJobService);
       // stopService(pendingJobService);


        checkPermissions();
        audioTrimmerActivity=new AudioTrimmerActivity();
...
// Share fucntion has been started
            ...
            if (null != selectedItems && selectedItems.length > 0) {
                Runnable runnable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        startActivity(Intent.createChooser(shareIntent, getString(R.string.action_share))); //my codes
                    }
                };
                handler.post(runnable);
            }
            return true;//ending share function
        }
//delete function codes
        if (id == R.id.action_delete) {
            ...
            return true;//ending delete codes
        }
...
//    Database callLog = Database.getInstance(MainActivity.this);
//    for (PhoneCallRecord record : selectedItems) {
//        //name, path, duration, size;
//        //AudioModel(String name, String path, String duration, String size)
//        com.jlcsoftware.models.AudioModel audioModel = new com.jlcsoftware.models.AudioModel(record.getName(),record.getPhoneCall().getPathToRecording(),record.)
//        int id = record.getPhoneCall().getId();
//        callLog.removeCall(id);
//    }
//
//}
    ...
    @Override
    public void onItemPlay(final PhoneCallRecord item) {
        AlertDialog.Builder alert = new AlertDialog.Builder(
                this);
        alert.setPositiveButton(R.string.dialog_play, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Runnable runnable = new Runnable() {
                    @Override
                ...
                SoundFile mLoadedSoundFile = null;
                try {
                    Log.e("main",""+getString(R.string.thepath));
                    //mLoadedSoundFile = SoundFile.create(item.getPhoneCall().getPathToRecording());
                    mLoadedSoundFile = SoundFile.create(getString(R.string.thepath));
                } catch (IOException e) {
             ...
             // audioTrimmerActivity.finishOpeningSoundFile(mLoadedSoundFile,0);
...
//        alert.setNegativeButton(R.string.dialog_trim, new DialogInterface.OnClickListener() {
//            @Override
//            public void onClick(DialogInterface dialog, int which) {
//
//                SoundFile mLoadedSoundFile = null;
...
//        });
        alert.show();
        Toast.makeText(this, "play button cliccked", Toast.LENGTH_SHORT).show();
    }
    @Override
    ...
    @Override
    public void onTrim(PhoneCallRecord mItem) {
//        Toast.makeText(audioTrimmerActivity, "On trim fucntio calle3d", Toast.LENGTH_SHORT).show();
//        Log.e("main",""+mItem.getPhoneCall().getPathToRecording());
//        SoundFile mLoadedSoundFile = null;
//        try {
//            Log.e("main","loaded");
//            mLoadedSoundFile = SoundFile.create(mItem.getPhoneCall().getPathToRecording());
//        } catch (IOException e) {
//            Log.e("main",e.getMessage().toString());
//            e.printStackTrace();
//        } catch (SoundFile.InvalidInputException e) {
